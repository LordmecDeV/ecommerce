      ...
      <div class="col-md-3 mb-5">
        <div class="card p-2 space-margin-left-5 shadow bg-body circle-rounded" style="width: 18rem;">
          ...
          <div class="card-body mb-4">
            ...
            <h5 class="card-text text-center fw-bold font-price font-price color-card-information" style="margin-top: 0.05rem;">Por R$ <span class="color-card-information span-price">{{$bestSellers->price}}</span></h5>
