...
<div class="container">
  ...
  <div class="row ">
    ...
    <img src="{{$viewFrames->image_product_1}}" class="card-img-top" alt="...">
    <div class="card-body">
    <h5 class="card-title text-center title-card">{{$viewFrames->name}}</h5>
    <p class="card-text text-center price-card">R$ {{$viewFrames->price}} <a href="#" class="a-href-card">no pix</a></p>
    ...
    <a href="{{ route('showProductClient', ['id' => $viewFrames->id]) }}" class="btn btn-secondary d-flex justify-content-center">Ver mais...</a>
    </div>
    </div><!-- final do card -->
    </div>
    @endforeach
