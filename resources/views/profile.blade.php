      ...
      <div class="row">
        <div class="col-12 col-xl-4">
          <div class="card h-100">
            ...
            <ul class="list-group">
          <li class="list-group-item">{{$viewProduct->name}}</li>
          <li class="list-group-item">{{$viewProduct->sku}}</li>
          <li class="list-group-item">{{$viewProduct->tag}}</li>
          <li class="list-group-item">{{$viewProduct->type_product}}</li>
          <li class="list-group-item">{{$viewProduct->status}}</li>
            </ul>
            </div>
          </div>
        </div>
