...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
       ...
       <span class="ms-3 font-weight-bold">Lugar Nenhum Store</span>
    </a>
  </div>
  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item mt-2">
        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Administrar Produtos</h6>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('cadastrar-produto') ? 'active' : '') }} " href="{{ url('cadastrar-produto') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('todosProdutos') ? 'active' : '') }}" href="{{ url('todosProdutos') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('todos-cupons') ? 'active' : '') }}" href="{{ url('todos-cupons') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('todas-newsletter') ? 'active' : '') }}" href="{{ url('todas-newsletter') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Newsletter Build</span>
        </a>
      </li>
      <li class="nav-item mt-2">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('administrar-conteudo') ? 'active' : '') }}" href="{{ url('administrar-conteudo') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <span class="nav-link-text ms-1">Editar Paginas</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('precos-e-tamanhos') ? 'active' : '') }}" href="{{ url('precos-e-tamanhos') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <span class="nav-link-text ms-1">Tamanhos e preços</span>
        </a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item mt-3">
        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Administrar acessos</h6>
      </li>
      <li class="nav-item">
